(function() {
    ...
    angular.module('tree-implementation', ['ui.tree'])
    ...
    .factory('treeServer', ['$http', '$q', function ($http, $q) {
        ...
        return {
            ...
            apiGetTreeLocation: "http://ramsegev-001-site1.smarterasp.net/api/tree",
            apiLocation: "http://ramsegev-001-site2.smarterasp.net/api",
            /**
            ...
            getTree: function (xmlFileId) {
                ...
                return $q(function (resolve, reject) {
                    ...
                    $http.get(self.apiGetTreeLocation + '/getTreeJson?xmlFileId=' + xmlFileId).then(function (response) {
                        try {
    ...
    .controller('home', ['treeServer', '$scope', function(treeServer, $scope) {
        ...
        treeServer.getTree(30).then(function(list) {
